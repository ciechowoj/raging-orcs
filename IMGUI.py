...
class IMGUI:
    """Klasa implementująca wzorzec Immediate Mode GUI."""
    ...
    def begin(self, surface):
        """Zaczyna rysowanie konrolek. Kontrolki powinny być rysowane pomiędzy begin/end."""
        self._surface = surface

    def end(self):
        """Kończy rysowanie konrolek."""
    ...
    def set_focus(self, id):
        """Ustawia focus klawiatury na danej kontorlce."""
        self._having_focus = id

    def has_focus(self, id):
        """Sprawdza czy dana kontrolka ma focus."""
