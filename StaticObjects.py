...
class StaticObjects:
    """Kolekcja przechowująca i organizująca rysowanie statycznych obiektów."""
    ...
    def redraw(self, surface, position, frames):
        """Zwraca listę krotek (pozycja, ramka animacji) obiektów które trzeba odrysować."""
    ...
    def del_objects(self, position, size):
        """Usuwa obiekty znajdujące się na podanej pozycji z kolekcji."""
    ...
    def set_sprites(self, sprites):
        """Ustawia zestaw "duszków" obiektów."""
        self._sprites = set(sprites)

    def get_sprites(self):
        """Zwraca zestaw "duszków" obiektów."""
    ...
    def set_size(self, size):
        """Zmienia rozmiar kolekcji, zachowuje poprzednie elementy."""
