...
class ObjectSprite:
    """"Klasa implementuje wczytywanie oraz wyświetlanie "duszków" obiektów gry."""
    PI2 = 2 * pi
    INV_2PI = 1.0 / (2 * pi)
    ...
    def get_frame_i(self, time):
        """Zwraca indeks ramki w zależności od czasu."""
        return floor(time / self._time % self._size.x)
    ...
    def get_file_name(self):
        """Zwraca nazwę pliku z którego "duszek" został wczytany."""
        return self._file_name

    def get_offset(self):
        """Zwraca pionowe przesunięcię z jakim powinien być odrysowany obiekt."""
